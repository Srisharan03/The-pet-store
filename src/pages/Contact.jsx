      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Have a question or need help? We're here to assist you and your pets.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">sales@petstore.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">We offer 30-day returns on all unused items in original packaging.</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">Do you offer free shipping?</h4>
                  <p className="text-gray-600 text-sm">Yes! Free shipping on all orders over $50.</p>
                </div>
                <div>
